...
{  
    ...
    magbias[0] = 142.72;   // User environmental x-axis correction in milliGauss
    magbias[1] = -140.65;  // User environmental y-axis correction in milliGauss
    magbias[2] = -127; // User environmental z-axis correction in milliGauss
